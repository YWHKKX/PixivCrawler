...
var GlobalTag_Negative []string = []string{
	"EasyNegative", "badhandsv5-neg", "Subtitles", "word", "bad hands",
	"oversaturated", "vibrant colors", "neon colors", "high saturation", "garish",
	"((logo))", "watermark", "(3d, photo, hyperrealistic, rough sketch:1.1)",
	"(derpibooru_p_low)", "source comic", "monochrome", "text", "signature",
	...
	"(cloned face:1.2)", "(multiple people:1.5)",
	"overlapping figures", "merged bodies", "(bad anatomy:1.5)",
	"(malformed limbs:1.3)", "extra arms", "out of focus", "blurry",
	...
	"watermark", "extra legs", "bad legs", "fused legs", "asymmetric legs",
	"(asymmetrical legs:1.3)", "(disconnected thighs:1.2)",
